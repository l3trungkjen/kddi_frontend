    ...
    public function stepTwoSubmit(Request $request)
    {
        try {
            ...
            $data = [
                ...
                // Pháp nhân
                "法人郵便番号" => ["value" => $request->post_code],
                "個人住所1" => ["value" => $request->contact_prefectures],
                "個人住所2" => ["value" => $request->contact_municipalities],
                "個人住所3" => ["value" => $request->contact_street],
                "個人住所4" => ["value" => $request->contact_building_name],
                ////////////////////
                "法人部署名" => ["value" => $request->department],
                "法人電話番号" => ["value" => $request->telephone],
                "法人メールアドレス1" => ["value" => $request->email],
                ...
                // Cá nhân
                "個人郵便番号" => ["value" => $request->contact_post_code],
                "法人住所1" => ["value" => $request->prefectures],
                "法人住所2" => ["value" => $request->municipalities],
                "法人住所3" => ["value" => $request->street],
                "法人住所4" => ["value" => $request->building_name],
                ////////////////////
                "個人電話番号" => ["value" => $request->contact_telephone],
