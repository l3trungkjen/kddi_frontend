...
@section('content')
    <main>
        ...
        <div class="flow">
          ...
          <div class="flow_pt"><p><a href="/purchase/step-one">端末買取専用のお申込みフォーム</a>に必要情報を入力し、お申込みください。必要な情報を送信いただくと、受付完了メールをお送りいたします。</p>
          </div>
          </div>
          ...
          <div class="flow_detail">
          <div class="flow_ph"><img src="{{ asset('images/flow09.jpg') }}"></div>
          <div class="flow_pt"><p>お売りいただく端末を発送するための、買取キット一式をお客様宛てに送付いたします。<br>
          買取キット発送先に複数をご指定いただいた場合は、ご通知いただいた各発送先にお送りいたします。</p>
          </div>
          <div class="flow_waku1">
          <h3>買取キット 内容</h3>
          <p>鍵付発送箱／送付明細書／着払い伝票</p>
          <div class="kit">
          ...
          <img src="{{ asset('images/flow05.jpg') }}">
            ...
            <div class="flow_pt"><p>お売りいただく端末の初期化など、発送準備をお願いいたします。</p>
            <div class="flow_waku3">
            <h3>ご準備いただく内容</h3>
            <dl>
            <dt>データの削除</dt>
            <dd>スマートフォンの初期化機能を使用し、オールリセット可能な場合は実施をお願いいたします。<br>
            ...
            <span class="tel">0800-0800-111</span></p>
            </div>
            </div>
            </div>
            </div>
            ...
            <div class="flow_detail">
            <div class="flow_ph"><img src="{{ asset('images/flow10.jpg') }}"></div>
            <div class="flow_pt"><p>お売りいただく全ての端末が到着しましたら、受け取り確認・台数確認のメールをお送りいたします。<br>
            ...
            <div class="flow_detail">
            <div class="flow_ph"><img src="{{ asset('images/flow11.jpg') }}"></div>
            <div class="flow_pt"><p>データ消去が完了次第、データ消去作業完了証明書をメールにてお送りいたします。</p>
            </div>
            </div>
            ...
            <div class="flow_detail">
            <div class="flow_ph"><img src="{{ asset('images/flow12.jpg') }}"></div>
            <div class="flow_pt"><p>リサイクルを行う端末は破砕し、破砕処理作業完了証明書をメールにてお送りします。<br><br>
            ...
            <div class="fin">
            <p>お売りいただきました端末は<br class="v_sm">国内外で再活用（リユース）や、<br>
            資源化（リサイクル）させていただきます。</p>
            </div>
        </div>
