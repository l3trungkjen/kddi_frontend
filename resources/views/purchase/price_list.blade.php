                ...
                <table id="table_categories">
                    <thead>
                        <tr>
                            ...
                            <th colspan="4">
                                下取り価格目安<br>
                                <span>（ランク基準は<a href="#" data-toggle="modal" data-target="#modal1">こちら</a>）</span>
                            </th>
                        </tr>
                        <tr>
                            <th class="rank">A</th>
...
@section('script')
    <script
        src="{{ env('APP_ENV') == 'production' ? secure_asset('js/bootstrap-4.0.0.js') : asset('js/bootstrap-4.0.0.js') }}">
    </script>
