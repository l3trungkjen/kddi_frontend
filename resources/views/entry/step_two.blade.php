      ...
      <div class="formarea">
        <div class="formcat">
            <div class="h-adr">
                ...
                <dl>
                    <dt><label>都道府県<span class="required">必須</span> <span class="notice">※郵便番号から自動入力</span></label>
                    </dt>
                ...
                <dl>
                    <dt><label>市区町村<span class="required">必須</span> <span class="notice">※郵便番号から自動入力</span></label>
                    </dt>
        ...
        <div class="formcat">
          ...
          <dl>
              ...
              <dd>
                  <div class="yoko"><input id="" role="radio" type="radio" name="事業者"
                          value=""><span>適格請求書発行事業者</span></div>
                  <div class="yoko"><input id="" role="radio" type="radio" name="事業者"
                          value=""><span>免税事業者</span></div>
              </dd>
          </dl>
        ...
        <div class="formcat">
          ...
          <dl>
              ...
              <dd><input name="" required="required" id="" type="text"
                      class="entry-input"></dd>
          </dl>

          <dl>
              <dt><label>口座種別<span class="required">必須</span></label></dt>
              <dd>
                  <div class="yoko"><input id="" role="radio" type="radio" name="口座種別"
                          value=""><span>普通</span></div>
                  <div class="yoko"><input id="" role="radio" type="radio" name="口座種別"
                          value=""><span>当座</span></div>
                  <div class="yoko"><input id="" role="radio" type="radio" name="口座種別"
                          value=""><span>貯蓄</span></div>
                  <div class="yoko"><input id="" role="radio" type="radio" name="口座種別"
                          value=""><span>その他</span></div>
              </dd>
          </dl>
        ...
        <div class="formcat">
          <div class="h-adr">
            ...
            <p>※ ご自宅の住所のご入力をお願いいたします。<br>（古物営業法条、ご担当者様のご自宅の連絡先が必要となります）</p>
            <dl>
            ...
            <dl>
                <dt><label>建物名・フロア等</label></dt>
                <dd><input name="" required="" id="" type="text" class="entry-input">
                </dd>
            </dl>
            ...
            <dl>
                <dt><label>生年月日<span class="required">必須</span> <span
                            class="notice">入力例：19900808</span></label></dt>
                <dd><input name="" required="required" id="" type="text"
                        class="entry-input"></dd>
            </dl>
