...
@section('content')
  <main>
    ...
    <form method="POST" id="entry_step_one" action="/entry/edit-step-one-submit">
      @csrf
      <div class="formarea">
        <div class="formcat">
          <div class="h-adr">
            ...
            <dl>
              ...
              <dd>
                ...
                <input type="text" class="p-postal-code entry-input" name="post_code" id="post_code" size="8" maxlength="8" value="{{ $member['法人郵便番号']['value'] }}">
              </dd>
            </dl>
            <dl>
            ...
            <dl>
              ...
              <dd><input type="text" class="p-locality p-street-address entry-input" name="municipalities" id="municipalities" value="{{ $member['個人住所2']['value'] }}"></dd>
            </dl>
            <dl>
              <dt><label>番地以降<span class="required">変更可</span></label></dt>
              <dd><input type="text" class="p-extended-address entry-input" name="street" id="street" value="{{ $member['個人住所3']['value'] }}"></dd>
            </dl>
            <dl>
            ...
            <dl>
              ...
              <dd><input required="required" type="text" class="entry-input" name="department" id="department" value="{{ $member['法人部署名']['value'] }}"></dd>
            </dl>
            <dl>
            ...
            <dl>
              ...
              <dd><input required="required" type="text" class="entry-input" name="email" id="email" value="{{ $member['法人メールアドレス1']['value'] }}"></dd>
            </dl>
            <dl>
              <dt><label>メールアドレス（確認用）</label></dt>
              <dd><input required="required" type="text" class="entry-input" name="confirm_email" id="confirm_email" value="{{ $member['法人メールアドレス2']['value'] }}"></dd>
            </dl>
          </div>
        </div>
        <div class="formcat">
